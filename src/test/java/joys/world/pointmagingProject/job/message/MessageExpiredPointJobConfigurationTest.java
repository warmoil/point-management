...
class MessageExpiredPointJobConfigurationTest extends BatchTestSupport {
    ...
    void messageExpiredJob() throws Exception {
        ...
        LocalDate expiredDate = LocalDate.of(2021, 9, 5);
        LocalDate notExpiredDate = LocalDate.of(2024, 12, 31);
        ...
        pointRepository.save(new Point(wallet1, 1000L, earnDate, expiredDate, false, true));
        pointRepository.save(new Point(wallet1, 1000L, earnDate, expiredDate, false, true));
        pointRepository.save(new Point(wallet1, 1000L, earnDate, expiredDate, false, true));

        pointRepository.save(new Point(wallet2, 1000L, earnDate, expiredDate, false, true));
        ...
        JobParameters jobParameters = new JobParametersBuilder()
                ...
                .toJobParameters();
        JobExecution execution = launchJob(messageExpiredJob, jobParameters);
        ...
        then(message2.getTitle()).isEqualTo("1000 포인트 만료");
        then(message2.getContent()).isEqualTo("2021-09-06 기준 1000 포인트가 만료되었습니다.");
